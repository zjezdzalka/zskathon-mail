...
class RegisteredEmail:
    def __init__(self, email_host : str, email_user : str, email_pass : str, discord_channel_id : int = 0, discord_channel_webhook : str = None, smtp_port : int = 587, imap_port : int = 993, allow_replies : int = 1, discord_role_ping : str = None):
        ...
        self.discord_role_ping = discord_role_ping
